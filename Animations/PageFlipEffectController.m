...
- (void)handlePan:(UIPanGestureRecognizer *)sender {
    ...
    _layer.contents  = (__bridge id)([UIImage imageNamed:x >= Width / 2.0f ? @"pic_2" : @"pic_1"].CGImage);
    ...
    if (sender.state == UIGestureRecognizerStateEnded) {
        ...
        // 空间旋转
        perspectiveTransform = CATransform3DRotate(perspectiveTransform, [Math radianFromDegree:x >= Width / 2.0f ? 180 : 0], 0, 1, 0);
