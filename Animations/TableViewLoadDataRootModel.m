...
@implementation TableViewLoadDataRootModel
...
- (void)setValue:(id)value forKey:(NSString *)key {
    ...
    // meta
    if ([key isEqualToString:@"meta"] && [value isKindOfClass:[NSDictionary class]]) {
        
        value = [[MetaModel alloc] initWithDictionary:value];
    }
